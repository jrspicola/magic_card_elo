...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cardColor', models.CharField(help_text='Enter a color', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='CardComparison',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cardSet', models.CharField(help_text='Enter the name of a set', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='CardType',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cardType', models.CharField(help_text='Enter a card type', max_length=50)),
            ],
        ),
        migrations.AddField(
            model_name='card',
